<template>
    <div class="d-flex flex-column align-content-center text-bg-light w-100 h-100 mx-auto">
        <div class="vstack gap-4 align-items-center p-5">
            ...
            <button v-if="role=='Admin'" class="btn btn-lg btn-success" @click="createNew">
            ...
            <div class="d-flex flex-row rounded announcement p-4" v-for="announcement in announcements" :key="announcement.text">
                <div class="message fs-3" @click="expand(announcement)">
                    {{ announcement.text }}
                </div>
                <!-- only show if Admin -->
                <div v-if="role=='Admin'" class="d-flex flex-column buttons" >
                    <button class="btn btn-secondary m-1" @click="edits(announcement)">
                    ...
                    <button class="btn btn-danger m-1" @click="deletes(announcement)">
