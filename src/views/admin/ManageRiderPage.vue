<template>
    <div>
        <h1 class="fs-1 p-3">Manage Rider Information</h1>
            ...
            <table class="table table-striped w-75 border border-primary">
                ...
                <tbody>
                    <tr v-for="(rider, index) in riderList" :key="index">
                        ...
                        <td>{{ rider.height }}</td>
                        <td>{{ rider.weight }}</td>
                        <td> <button @click="editForm(rider, index)" type="button" class="btn btn-primary"
                                data-bs-toggle="modal" data-bs-target="#editRider">Edit</button> </td>
                        <td> <button @click="selectMessage(index)" type="button" class="btn btn-primary"
                                data-bs-toggle="modal" data-bs-target="#areYouSure">Delete</button> </td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="d-flex justify-content-center">
            <div class="d-flex w-75 justify-content-between">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRider">Add Rider to
                    List</button>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadFile">Add Rider
                    Data from .csv</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="updateData">Save
                        changes</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        @click="deleteData(msg)">Confirm</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        @click="handleFileUpload">Confirm</button>
                </div>
            </div>
        </div>
    </div>
